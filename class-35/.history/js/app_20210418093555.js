...
function createMe() {
    ...
    for (let i = 0; i < toDo.length; i++) {
        result1 += ""
        "<div class='alert alert-dark d-flex justify-content-between align-items-center'>" + [i] + "<button class='btn btn-success' type='button' onclick='checkMe(" + i + ")'>&check;</button>" + "</div>"
    }
