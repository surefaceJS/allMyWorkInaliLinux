...
function addProduct() {
    ...
    if (selectedIndex >= 0) {
        products[selectedIndex] = newProdact;
        selectedIndex = -1;
    } else {
...
function drawCards() {
    ...
    for (let i = 0; i < products.length; i++) {
        result +=
            ...
            "<div class='card'>" +
            "<div class='card-header text-center text-waring'><h5>" + products[i].name + "</h5></div>" +
            "<div class='card-body'>" +
            ...
            "<button type='button' class='btn btn-danger ' onclick='delatePruduct(" + i + ")'>Delete</button>" +
            "</div>" +
            "</div>" +
            "</div>"
    }
